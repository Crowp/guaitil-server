...
public class EmailNewLocalTemplate {
    ...
    public String makeTemplate(){
        return "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional //EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n" +
                ...
                "\n" +
                "                                      <span style=\" font-size: 14px; line-height: 19.6px;\">\n" +
                "                                        Tu local "+this.localName+" ha sido agregado exitosamente al sistema, puedes \n" +
                "                                        obervarlo en tu apartado.\n" +
                "                                    </span>\n" +
                "                                    </p>\n" +
                "                                <br />\n" +
                ...
                "                                    Para ingresar a la p&aacute;gina, dale\n" +
                "                                    click en el siguiente bot&oacute;n:\n" +
                "                                  </span>\n" +
                "                                </p>                                \n" +
                "                                  </div>\n" +
                "                                </td>\n" +
